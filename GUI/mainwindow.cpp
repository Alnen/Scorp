...
void MainWindow::defineToolBar()
{
    ...
    actSetViewMode = new QAction(QIcon(QPixmap("../Scorp/GUI/images/view.png")), tr("View"), m_toolBar);
    actSetMoveMode = new QAction(QIcon(QPixmap("../Scorp/GUI/images/move.png")), tr("Move"), m_toolBar);
    actSetAddStateMode = new QAction(QIcon(QPixmap("../Scorp/GUI/images/state.png")), tr("Add State"), m_toolBar);
    actSetAddLinkMode = new QAction(QIcon(QPixmap("../Scorp/GUI/images/link.png")), tr("Add Link"), m_toolBar);
    actSetDeleteMode = new QAction(QIcon(QPixmap("../Scorp/GUI/images/delete.png")), tr("Delete"), m_toolBar);
